      ...
      <div className="flex flex-col justify-center items-center w-full h-full">
        ...
        <div className="max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4">
          <div className="sm:text-right text-2xl font-bold">
            <p>Hi, I'm Quan</p>
            <p>
              I am a detail-oriented front-end developer, lifelong learner with
              more than 2 years experience and passion for responsive website
              design
            </p>
            <br></br>
            <p>
              I would love to work in these field, which gain more knowledge and
              contribute in these evolving technologies
            </p>
          </div>
          <div>
